			...
			<div class="large-8 collapse" columns>				
				...
				<div class="row">
					<dl style="border-top:1px solid #E8E8E8" class="tabs" data-tab>
						...
						<dd style="width:33.333333333%"><a href="#badges">Badges</a></dd>
					...
					<div class="tabs-content">
						...
						<div class="content" id="badges">
							<?php if(empty($materibadge) && empty($allbadge)){ echo '<center><h3>this user don\'t have any badge</h3></center>';}else{?>
